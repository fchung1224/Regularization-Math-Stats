...
Therefore the true values of Y will be estimated by the following formula
$$
Y = X\beta + \epsilon 
$$
Where $\epsilon \sim N(0,25)$, and our x-values are all derived using a multivariate normal distribution. 

X values are individually normal but they are multicollinear within each other. 
